...
yes | $ANDROID_HOME/tools/bin/sdkmanager "platform-tools" "platforms;android-28" "emulator"
yes | $ANDROID_HOME/tools/bin/sdkmanager "system-images;android-28;google_apis;x86_64"
emulator -version
